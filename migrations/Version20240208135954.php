 ...
 */
final class Version20240208135954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom_user VARCHAR(64) NOT NULL, mail_user VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role_user VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64920E84520 (mail_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
